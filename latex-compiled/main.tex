...
\title{\vspace{-0.5cm}{\huge \textbf{General Knowledge: Agriculture}}\\[3mm]
\hrule
}
\date{}
...
% \pagestyle{empty} % turn off page number and everything, this is useful when binding the pdf to knitted document

% set header and footer
\author{Deependra Dhakal}

\lhead[]{\today}
\chead[]{\large General Knowledge: Agriculture}
...
\include{agriculture-knowledge-objectives-set4}
\include{agriculture-knowledge-objectives-set5}
\include{agriculture-knowledge-objectives-set6}
\include{agriculture-knowledge-objectives-set7}
\include{agriculture-knowledge-objectives-set8}
\include{agriculture-knowledge-objectives-set9}
\include{agriculture-knowledge-objectives-set10}
