...
## Geography, demography and agriculture sector of Nepal
...
- Political division of Nepal constitutes 753 local levels among which,
  - Metropolitan city: 6
  - Sub metropolitan city: 11
  - Municipality: 276
  - Village municipality: 460

- Population: 28.71 million (2073/74 estimate)
- Population growth rate: 1.35 (Census, 2068)

### Proportion of total land area and arable land by agro-ecological zones

```{r land-and-arable-agro-ecological-zones}
tribble(
  ~"Agro-ecological zone", ~"Fraction of total land area (percent)", ~"Arable land (percent)",
  "Terai", 35, 55,
  "Hills", 41.67, 37.5,
  "Mountains", 23.11, 7.5
) %>% 
...
tribble(~"region", ~"elevation", ~"climatic_zone", ~"average_annual_precipitation", ~"average_annual_temperature", 
  ...
  knitr::kable(booktabs = TRUE, escape = FALSE, caption = "Nepal\'s climatic zones (Adapted from MoE, 2010 and MoSTE, 2014)", longtable = TRUE, align = "l") %>% 
  kableExtra::kable_styling(latex_options = "striped", font_size = 8) %>% 
...
tribble(~"SN", ~"Agro-climate", ~"Elevation",
  ...
  knitr::kable(booktabs = TRUE, caption = "Nepal\'s climatic zones (Adapted from MoE, 2010 and MoSTE, 2014)", longtable = TRUE, align = "l") %>% 
  kableExtra::kable_styling(latex_options = "striped", font_size = 8) %>% 
...
### Production status of crops, livestock and poultry
...
read_csv("./data/status_of_agricultural_crops_production_2020.csv", skip = 3, show_col_types = FALSE) %>% 
  knitr::kable(caption = "Status of agricultural crops production (Potato and honey is included in cash crops. Sugarcane, jute, tea, coffee, fishery and cotton are included in industrial crops.) in 2020", longtable = TRUE, booktabs = TRUE) %>% 
...
### Macroeconomic indicators -- sectoral contribution in value and its growth rate

```{r macroeconomic-indicators}
read_csv("./data/macro-economic_indicators.csv",
         skip = 2, show_col_types = FALSE) %>% 
  mutate(`Meta-indicator` = str_replace_all(`Meta-indicator`, " \\(", ", ")) %>% 
  mutate(`Meta-indicator` = str_remove_all(`Meta-indicator`, "\\)")) %>% # latex multicolumn acts batshit when using parenthesis in the cell
  kableExtra::kbl(booktabs = TRUE, caption = "Macroeconomic indicators of Nepal in recent years", longtable = TRUE, escape = FALSE, format = "latex") %>% 
  kableExtra::kable_styling(font_size = 8) %>% # do not use latex_options = "striped"
  kableExtra::column_spec(column = 1:9, width = c("2em", "8em", rep("4em", 7))) %>%
...
### Employment related key indicators
...
read_csv("./data/status_of_credit_services_to_livestock_and_vegetables_2020_edited.csv", skip = 2,
         show_col_types = FALSE) %>% 
  knitr::kable(booktabs = TRUE, longtable = TRUE, caption = "Status of credit services to livestock and vegetable crops (as of 2020)") %>% 
  kableExtra::kable_styling(font_size = 8, latex_options = "striped") %>% 
...
read_csv("./data/province-wise_distribution_of_forest_sector_2020.csv", skip = 2,
         show_col_types = FALSE) %>% 
  knitr::kable(booktabs = TRUE, longtable = TRUE, caption = "Provincewise status of forest area (as of 2020)") %>% 
  kableExtra::kable_styling(font_size = 8, latex_options = "striped") %>% 
  kableExtra::column_spec(column = 1:5, width = c("16em", rep("8em", 4)))
...
read_csv("./data/province-wise_details_micro_cottage_small_industries_2020.csv", skip = 3, 
         show_col_types = FALSE) %>% 
  knitr::kable(booktabs = TRUE, caption = "Province-wise details of micro, cottage and small industries (as of 2020)", longtable = TRUE) %>% 
  kableExtra::kable_styling(font_size = 8, latex_options = "striped") %>% 
...
read_csv("./data/province-wise_total_hydropower_generation_2020.csv", skip = 4,
         show_col_types = FALSE) %>% 
  knitr::kable(booktabs = TRUE, caption = "Province-wise hydro-electricity generation (as of 2020)", longtable = TRUE) %>% 
  kableExtra::kable_styling(latex_options = "striped", font_size = 8) %>% 
...
read_csv("./data/indicators_of_educational_achievements_2020.csv", skip = 2,
  ...
  kableExtra::column_spec(column = 1:8, width = c("3em", "8em", rep("5em", 6))) %>%
  kableExtra::collapse_rows(columns = 1:2, row_group_label_position = "stack",
                            headers_to_remove = 1, valign = "middle")
```


## Planning periods of Nepal

```{r periodic-plans-timeline}
tribble(
  ~"Plan", ~"Starting year in AD(BS)", ~"Final year in AD(BS)",
  "1st Five year plan", "1956/57 (2013/14)", "1960/61 (2017/18)",
  "2nd Three year plan", "1962/63 (2019/20)", "1964/65 (2021/22)",
  "3rd Five year plan", "1965/66 (2022/23)", "1969/70 (2026/27)",
  "4th Five year plan", "1970/71 (2027/28)", "1974/75 (2031/32)",
  "5th Five year plan", "1975/76 (2032/33)", "1979/80 (2036/37)",
  "6th Five year plan", "1980/81 (2037/38)", "1984/85 (2041/42)",
  "7th Five year plan", "1985/86 (2042/43)", "1989/90 (2046/47)",
  "8th Five year plan", "1992/93 (2049/50)", "1996/97 (2053/54)",
  "9th Five year plan", "1997/98 (2054/55)", "2001/02 (2058/59)",
  "10th Five year plan", "2002/03 (2059/60)", "2006/07 (2063/64)",
  "11th Three year plan", "2007/08 (2064/65)", "2009/10 (2066/67)",
  "12th Three year plan", "2010/11 (2067/68)", "2012/13 (2069/70)",
  "13th Three year plan", "2013/14 (2070/71)", "2015/16 (2072/73)",
  "14th Three year plan", "2016/17 (2073/74)", "2018/19 (2075/76)",
  "15th Five year plan", "2019/20 (2076/77)", "2023/24 (2080/81)"
  ) %>% 
  knitr::kable(booktabs = TRUE, caption = "A timeline histroy of periodic plans launched in Nepal.", longtable = TRUE) %>% 
  kableExtra::kable_styling(font_size = 8) %>% 
  kableExtra::column_spec(column = 1:3, width = c("10em", "10em", "10em"))
```
...
tribble(
  ~"Season", ~"Duration", ~"Rainfall", ~"Alternative name", 
...
tribble(
  ...
  knitr::kable(booktabs = TRUE, caption = "Climate change scenario in Nepal and some indicators", longtable = TRUE, align = "l") %>% 
  kableExtra::kable_styling(latex_options = "striped", font_size = 8) %>% 
...
tribble(
  ...
  knitr::kable(booktabs = TRUE, caption = "High level federalism implementation and state restructuring steering committee", longtable = TRUE, align = "l") %>% 
  kableExtra::kable_styling(font_size = 8, latex_options = "striped") %>% 
  kableExtra::column_spec(column = 1:3, width = c("3em", "16em", "6em"))
```
...
"Food sovereignty" means the following rights which are used or exercised by the farmers in the food production and distribution system:
...
readxl::read_xlsx("./data/app_targets_performance_indicators.xlsx", sheet = "app_base_2010") %>% 
  ...
  kableExtra::kable_styling(font_size = 8, latex_options = "striped") %>% 
  kableExtra::column_spec(column = 1, width = "14em")
...
- Director, Economic administration
...
**Commodity research programs and centers**
