...
readxl::read_xlsx("./data/varietal_notification_status.xlsx") %>% 
  ...
  knitr::kable(caption = "Overview of released, registered and denotified varieties of crops", booktabs = TRUE) %>% 
  kableExtra::kable_styling(latex_options = "striped") %>% 
  kableExtra::column_spec(column = 3:7, width = c("6em", "6em", "10em", "10em", "6em"))
```
...
readxl::read_xlsx("./data/seed_certification_requirements.xlsx", sheet = "field_standards") %>% 
  ...
  kableExtra::kable_styling(latex_options = "striped") %>% 
  kableExtra::column_spec(column = 1:9, width = c("5em", rep("6em", times = 8)))
```
