...
tribble(
  ...
  kableExtra::kable_styling(latex_options = "striped") %>% 
  kableExtra::column_spec(column = 1:4, width = c("4em", "6em", "8em", "6em")) %>% 
...
tribble(
  ...
  kableExtra::kable_styling(latex_options = "striped") %>% 
  kableExtra::column_spec(column = 1:4, width = c("8em", "6em", "8em", "6em"))
```
...
readxl::read_xlsx("./data/weed_management.xlsx", sheet = "herbicides_rice", skip = 1, col_names = TRUE) %>% 
  ...
  kableExtra::kable_styling(position = "center", latex_options = c("HOLD_position"), font_size = 8) %>% 
  kableExtra::row_spec(0, bold = TRUE) %>% 
...
readxl::read_xlsx("./data/weed_management.xlsx", sheet = "herbicides_pigeonpea", skip = 1, col_names = TRUE) %>% 
  knitr::kable(caption = "Herbicidal control of Pigeonpea weeds", format = "latex", booktabs = TRUE) %>% 
