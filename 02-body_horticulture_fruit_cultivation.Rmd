...
- Spreading type shrub of family Actinidiaceae.
- There are two major kinds of Kiwi species found in Nepal: _Actinidia strigosa_ and _A. callosa_.
- In Nepal, Kiwi fruit was first planted in 2040 in Charikot, Dolakha.
...
- Cultivated in mountain region below the line of apple farming, in elevation 1200-2400 masl.
- Flowering: March-April
- Harvesting: November-December
- Popular propagation technique: Splice and bench grafting
- NPK: 170:56:100 per year per hectare.
- Spacing: 6 m x 6 m
- Varieties: Soyou, Bruno (Quicker maturing, high yielding and better storability than Hayward), Hayward (Required 600-800 hours of chilling period), Abbot, Allison
