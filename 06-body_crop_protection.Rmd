...
pest_management <- read_csv("./data/pest_management_pesticide.csv", skip = 1, show_col_types = FALSE)
...
pest_management %>% 
  ...
  kableExtra::column_spec(column = 2:11, width = c("8em", "4em", "6em",
                                                   "8em", "2em", "3em", "3em", "3em",
                                                   "10em", "12em")) %>% 
...
tribble(~"sn", ~"waiting_period (days)", ~"group", ~"common_name", 
  ...
  select(-1) %>% 
  rename_all(function(x)str_replace_all(x, "_", " ") %>% str_to_sentence()) %>% 
  knitr::kable(booktabs = TRUE, caption = "Waiting period of some commonly used pesticides", longtable = TRUE, align = "l") %>% 
  kableExtra::kable_styling(latex_options = "striped") %>% 
  kableExtra::column_spec(column = 1:3, c("6em", "6em", "20em"))
```
...
read_csv("./data/chemical_control_insects.csv", skip = 1, show_col_types = FALSE) %>% 
...
tribble(
  ...
  knitr::kable(booktabs = TRUE, caption = "Honey quality standards of Nepal and the Codex Alimentarius Commission", longtable = TRUE, escape = FALSE) %>% 
  kableExtra::kable_styling(latex_options = "striped", font_size = 8) %>% 
