...
events_membership_observances <- read_csv("./data/events_membership_observances.csv", skip = 1) %>% 
...
tribble(
  ...
  kableExtra::kable_styling(latex_options = "striped", font_size = 8) %>% 
  kableExtra::column_spec(column = 1:2, width = c("20em", "6em"))
```
...
read_csv("./data/agriculture_project.csv") %>% 
  knitr::kable(booktabs = TRUE, caption = "Major national and international projects working for agriculture development in Nepal", longtable = TRUE) %>% 
  kableExtra::kable_styling(font_size = 8, latex_options = "striped") %>% 
...
- Nurseries include
  ...
  - Biotic stree (Disease and insect)
- Activities:
...
- Under research and development of rice,
  ...
  - Disease mangement (biotic stress tolerance)
...
- Nepal has been member in steering committe of many consortiums,
