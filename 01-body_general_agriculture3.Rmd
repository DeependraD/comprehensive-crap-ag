...
read_csv("./data/draft/trade_balance_2075-76.csv") %>% 
...
province_import <- read_csv("./data/draft/province_import_2075-76.csv", skip = 1, col_types = cols(`F.Y 2018/19` = col_number()), na = "-") %>% 
...
- Minimum soil temperature for potato germination: \SI{8}{\celcius}
