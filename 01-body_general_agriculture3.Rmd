...
export_commodities %>%
  ...
  knitr::kable(booktabs = TRUE, caption = "Major traded commodities (export) of Nepal during fiscal year 2018/19 (2075/76)", longtable = TRUE, format.args = list(big.mark = ",", 
  scientific = FALSE)) %>% 
  kableExtra::kable_styling(font_size = 8, latex_options = "striped") %>% 
...
import_commodities %>%
  ...
  rename_all(function(x)str_replace_all(x, "_", " ")) %>% 
  knitr::kable(booktabs = TRUE, caption = "Major traded commodities (import) of Nepal during fiscal year 2018/19 (2075/76)", longtable = TRUE, format.args = list(big.mark = ",", 
  scientific = FALSE)) %>% 
  kableExtra::kable_styling(font_size = 8, latex_options = "striped") %>% 
