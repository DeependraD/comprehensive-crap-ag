...
tribble(
  ...
  knitr::kable(booktabs = TRUE, caption = "Difference between extension education and community development", longtable = TRUE) %>% 
...
tribble(
  ...
  knitr::kable(booktabs = TRUE, caption = "Difference between rural sociology and extension", longtable = TRUE) %>% 
  kableExtra::kable_styling(latex_options = "striped", font_size = 10) %>% 
