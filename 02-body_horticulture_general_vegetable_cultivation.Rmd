...
read_csv("./data/calcium_related_disorders_fruit_vegetables.csv", col_names = FALSE) %>% 
  knitr::kable(booktabs = TRUE, caption = "Physiological disorders related to calcium in fruit and vegetable crops", col.names = NULL, longtable = TRUE) %>% 
  kableExtra::kable_styling(font_size = 8) %>% 
  kableExtra::column_spec(column = 2, width = "18em")
```
...
read_csv("./data/crop_vegetable_fruits_maturity_indicators.csv", skip = 1) %>% 
  knitr::kable(booktabs = TRUE, caption = "Maturity indicators of some of the fruits and vegetables popular in Nepal") %>% 
...
tribble(
  ...
  knitr::kable(booktabs = TRUE, caption = "Expected harvestable yield of cucurbitaceous fruits on river bed farming.")
```
