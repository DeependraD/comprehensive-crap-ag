...
read_csv("./data/physiological_disorders.csv", skip = 1,
  ...
  kableExtra::column_spec(column = 2:5, width = c("10em", "12em", "12em", "6em")) %>% 
...
```{r onion-bulb, fig.cap="Onion and sections of its bulb", out.width="80%"}
...
## Propagation by cutting: Hardwood, semi-hardwood, softwood and herbaceous
...
With ever increasing demand in fruit due to increasing domestic population, increased tourist inflow and nutrition awareness, there is a thrust towards increasing land productivity. Only alternative to increase production in given parcel of land is to intensify cropping, besides increasing productivity of crop itself.

The concept of High Density Planting (HDP) arose out of similar needs of intensifying land use in fruit industry. It is an applied as well as successful orcharding practice in fruits like pear, apple, banana, pineapple, papaya, etc. HDP in mango was initiated at IARI and GB Pantanagar in 1974 and 1975, respectively.

HDP means more number of fruit trees than optimum through the manipulation of tree size and planting distance per unit area. Hence the broad obectives of implementing a HDP layout are:

- To make the best use of vertical and horizontal space per unit time.
- To harness maximum possible returns per unit of inputs.

An ideal planting distance is determined by complex integration of factors viz. cultivar, soil fertility, management intervention and economic consideration. Depending upon the number of plants per unit area, HDP can be categorized as:
...
Multistoried cropping is a resource conserving farming technique. In this cropping system, many tiers of crops are grown in a given piece of land while laying emphasis on utilization of vertical spaces rather than horizontal space. In a limited space, a number of crops could be grown at a time efficiently and economically. Although the original idea traces back to agro-forestry system, horticultural crops may be produced successfully under multistoried system of cultivation.

Multistoried cropping has certain specific requirements. Initially, plant species should be selected on the basis of their requirement for light, water and nutrient. Different species of crops are attuned to varying levels of light intensity. Secondly, the growth habit of the selected crop should be such that it disturbs the nearby crop the least in terms of utilization of the space.

An efficient example of multistory cropping in Nepal can be seen in eastern terai. Three crops, viz. arecanut (tall and small canopy), black pepper (climbing habit and takes support of trunk of arecanut) and turmeric or ginger (partial shade loving plant) is grown simultaneously in the same field. Here, all the available horizontal strata are fully utilized without any adverse effect on the productivity of individual crops. Similarly, banana and pineapple can be introduced into coconut orchard. Coconuts are initially space planted, while banana and pineapple are later planted forming the middle and innermost layers, respectively.
...
veg_mod %>% 
  ...
  kableExtra::column_spec(column = 1:3, width = c("6em", "14em", "8em"))
```
...
- Optimum temperature: \SI{20}{\celsius} for night and \SI{30}{\celsius} for day
- Red and yellow pigments develop at \SIrange{10}{25}{\celsius}
- It has been reported that lycopene formation is favoured at temperatures ranging from \SIrange{16}{21}{\celsius} and unfavoured at temperature values above \SI{30}{\celsius}
- Lycopene is destroyed above \SI{40}{\celsius}.
...
- Srijana
  ...
  - Released: 2066 BS
- Varieties (all are hybrids) released (as enlisted in Krishi Diary, 2078) other than above listed:
  - Gaurab-555
  - Amita
  - NS-815
  - Swaraksha
...
read_csv("./data/crop_vegetable_fruits_spacing.csv",  show_col_types = FALSE) %>% 
...
Most of Cucurbits are monoecious in nature and bears male and female flowers separately on the same plant. Similarly andromonoecious sex form is also common in Cucurbits where male and hermaphrodite flowers are borne separately in same plant. Monecious Cucurbits include cucmber, watermelon, longmelon, pumpkin, bottle gourd, snake gourd, chayote, etc. Similarly, andromonoecious sex form is common in bottle gourd, sponge gourd, snake gourd, muskmelon, etc.

Fruit set and yield of the crop depends upon the number of female flowers. Generally, male flowers open first and their number is comparatively larger than that of female flowers. High temperature, longer day light, high nitrogen fertilization, etc. are the major factors inducing maleness in Cucurbits. Although sex expression and sex ratio are varietal characteristics, they can be modified by providing suitable environment. Both plant growth regulators and nutrients at proper cencentration modify sex. Usually, 2-4 true leaf stage is the critical stage for suppression or promotion of either sex. There are several growth regulators available for sex modification and are broadly classified into two groups, viz.,

1. For promotion of staminate (male) flowers

- A single application of AgNO3 (600 mg/litre of water) before opening of flower.
- Application of high concentration of GA3 (1000 ppm),  first at 2 leaf stage and then after 10-15 days interval.

2. For promotion of pistillate (female) flowers

- Application of Ethrel (200-250 ppm) at 2nd and 4th true leaf stage.
- Spray of Maleic Hydrazide (50-100 ppm) at 2nd and 4th true leaf stage.
- Spray of 100 ppm of 2-Naphthalenic acetic acid (NAA), 2 ppm boron, 50 ppm 2,3,5-tri-iodobenzoic acid (TIBA).
