...
read_csv("./data/soil/nutrient_role_deficiency_control.csv") %>% 
  rename("SN" = "X1") %>% 
  knitr::kable(booktabs = TRUE, caption = "Role of crop nutrients, deficiency, control of deficiency and toxicity", longtable = TRUE) %>% 
  kableExtra::kable_styling(latex_options = "striped", font_size = 8) %>% 
...
tribble(
  ...
  knitr::kable(caption = "Flame colors produced by different elements in flame photometer") %>% 
